...
if __name__ == '__main__':
    filenames = ['CVE-2005-3807#vul#linux-2.6.11.2#locks.c#small#locks_delete_lock#582.c',
                 'CVE-2005-3807#vul#linux-2.6.14#locks.c#small#locks_delete_lock#556.c',
                 'CVE-2005-3807#fix#linux-3.18.122#locks.c#small#locks_delete_lock#687.c']
